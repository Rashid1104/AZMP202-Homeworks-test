...
// const WithT = arr.filter(item => item.name[0].toLowerCase() === 't');
// console.log(WithT);
...
// let count = 0;
// arr.forEach(item => {
//   if (item.name[0].toLowerCase() === 't' && item.name[item.name.length - 1].toLowerCase() === 't') {
//     count++;
//   }
// });
// console.log(count);
...
// arr.forEach(item => {
//     if (item.name[item.name.length - 1].toLowerCase() === 'e') {
//       item.name = 'SuperDev';
//     }
//   });
//   console.log(arr);
...
// const Uzunluq = arr.reduce((uzun, current) => {
...
// const max= arr.reduce((max, current) => current.key > max.key ? current : max, arr[0]);
...
// const con = arr.filter(item => (item.name.match(/t/g) || []).length >= 2);
// console.log(con);

// 12)

// const key = arr.filter(item => item.key > 10 && item.name[0].toLowerCase() === 'l');
// console.log(key);
...
//   const filtere = products.filter(product => product.rating.rate >= 3);
//   console.log(filtere);
...
// ? task3
//   const ByCategory = products.filter(product => product.category === "men's clothing");
...
// ? task5
// const sortTitle= [...products].sort((a, b) => a.title.localeCompare(b.title));
// const sortTitle = [...products].sort((a, b) => b.title.localeCompare(a.title));
