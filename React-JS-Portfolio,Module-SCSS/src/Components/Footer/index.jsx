    ...
    <footer className="bg-dark text-white py-5">
      <Container>
        ...
        <Row className="mt-4">
          <Col md={6}>
            <p className="mb-0">
              &copy; 2024 Kod Akademiya. Created with ❤️ by Rashid
            </p>
          </Col>

          <Col md={6} className="d-flex justify-content-end">
            <div className="d-flex gap-3">
              <a href="https://www.youtube.com/shorts/va2ZcaiGLDM" target='_blank' className="icons"><FaYoutube /></a>
              <a href="https://mail.google.com/mail/u/0/#inbox" target='_blank' className="icons"><SiGmail /></a>
              <a href="https://github.com/Rashid1104" target='_blank' className="icons"><FaGithub /></a>
              <a href="https://www.instagram.com/therock" target='_blank' className="icons"><FaInstagram /></a>
            </div>
          </Col>
        </Row>
      </Container>
