...
const Skills = () => {
  ...
  const skills = [
    { name: "HTML", experience: "2.5 Months Experience", icon: <FaHtml5 />, color: "#E34F26" },
    { name: "CSS", experience: "2.5 Months Experience", icon: <FaCss3Alt />, color: "#1572B6" },
    { name: "Sass", experience: "2.5 Months Experience", icon: <FaSass />, color: "#CF649A" },
    { name: "JavaScript", experience: "2 Months Experience", icon: <FaJs />, color: "#F7DF1E" },
    { name: "Bootstrap", experience: "2.5 Months Experience", icon: <FaBootstrap />, color: "#563D7C" },
