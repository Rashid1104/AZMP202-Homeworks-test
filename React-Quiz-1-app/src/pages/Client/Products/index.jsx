  ...
  return ( 
    <> 
      <Helmet prioritizeSeoTags> 
        ...
        <link rel="icon" type="image/x-icon" href="https://img.freepik.com/premium-vector/find-product-logo-design-template_145155-4160.jpg" /> 
      ...
      <div id="products"> 
        <Container> 
          <Grid container spacing={2}> 
            <Grid item xs={4} style={{ margin: "2rem 0" }}> 
              <TextField id="outlined-basic" label="Search" variant="outlined" onChange={handleSearch} /> 
            </Grid> 
            <Grid item xs={4} style={{ margin: "2rem 0", padding: "0 2rem" }}> 
              <FormControl fullWidth> 
                <InputLabel id="demo-simple-select-label">Sort</InputLabel>
                <Select labelId="demo-simple-select-label" id="demo-simple-select" label="Sort Products" onChange={(e) => { setSortValue(e.target.value); }}> 
              ...
              <FormControl fullWidth> 
                ...
                <Select labelId="demo-simple-select-label" id="demo-simple-select" label="Category" onChange={handleChange}>
                  ...
                  {categories.length > 0 && categories.map((c) => { 
                    return (
                      <MenuItem value={c.categoryName} key={c.id}> {c.categoryName} </MenuItem> 
                    ); 
                  })} 
                </Select> 
              </FormControl> 
